...
train_path = ""  # Put in path of where all the training folders exist.
test_path = ""  # Leave blank for now.
...
# Iterates through every single folder in the root provided.
classes = sorted([i.name.split("/")[-1] for i in root.iterdir()])

# This should print out all of the folders or rather classes of images of ingredients.
print(classes)
